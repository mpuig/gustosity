...
class BasicContactForm(ContactForm):
    ...
    """
    name = forms.CharField(label=_(u'Your name'), max_length=100, widget=forms.TextInput(attrs={'class': 'span9'}))
    email = forms.EmailField(label=_(u'Your email address'), max_length=200, widget=forms.TextInput(attrs={'class': 'span9'}))
    body = forms.CharField(label=_(u'Your message'), widget=forms.Textarea(attrs={'class': 'span9'}))
